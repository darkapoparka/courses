...
| Exact visual matches genuinely signed off | **127 / 159** |
| Full recorded flows genuinely signed off | **34 / 58** |
...
Latest acceptance: [profile menu and logout](reference-review/2026-09-23-account-settings-flow-review.md#profile-menu-and-logout-acceptance--2026-09-25) accepts `MATCH-fc5d84bd` and continuous `FLOW-079e1da7` on build `GM5iGeaIa4coS6v1WmWtj` after 164 states, 218 routes, 128 interactions and 159 exact comparisons with zero failures. Current ledger: UI 159/159, MATCH 127/159, FLOW 34/58.
...
Initial/current/localized lower-release order and lawful visible fragments are repaired. Exact captions, complete remaining covers, City Chart artwork, featured ordering, typography and controls still need final matching.
...
- [x] **UI-54b01eab — New — alpha featured cards.** Coded UI; current browser render passed.
  ...
  - [Reference image](../apple-music-clone/reference/originals/54b01eab-e635-4f54-882b-4bc62e7a2a4c.webp) · [Open app state](http://127.0.0.1:6435/screen/54b01eab-e635-4f54-882b-4bc62e7a2a4c) · [Component](../apple-music-clone/components/music-discovery.tsx)
...
- [x] **UI-f2e44e3b — New — superbloom featured cards.** Coded UI; current browser render passed.
  ...
  - [Reference image](../apple-music-clone/reference/originals/f2e44e3b-cb93-4607-a0bf-6e38aa56019d.webp) · [Open app state](http://127.0.0.1:6435/screen/f2e44e3b-cb93-4607-a0bf-6e38aa56019d) · [Component](../apple-music-clone/components/music-discovery.tsx)
...
- [x] **UI-6aa4a9d7 — New — verification form, step 2, signed out.** Coded UI; current browser render passed.
  ...
  - [Reference image](../apple-music-clone/reference/originals/6aa4a9d7-6cc9-4320-b237-5db6293b95de.webp) · [Open app state](http://127.0.0.1:6435/screen/6aa4a9d7-6cc9-4320-b237-5db6293b95de) · [Component](../apple-music-clone/components/music-auth.tsx)
...
- [x] **UI-4e65c7c6 — New — verification form, step 3, signed out.** Coded UI; current browser render passed.
  ...
  - [Reference image](../apple-music-clone/reference/originals/4e65c7c6-1268-4720-9509-6acfb97dd34f.webp) · [Open app state](http://127.0.0.1:6435/screen/4e65c7c6-1268-4720-9509-6acfb97dd34f) · [Component](../apple-music-clone/components/music-auth.tsx)
...
- [x] **UI-97de6907 — New — verification form, step 3, filled, signed out.** Coded UI; current browser render passed.
  ...
  - [Reference image](../apple-music-clone/reference/originals/97de6907-6131-4688-ab0d-34e81e99e379.webp) · [Open app state](http://127.0.0.1:6435/screen/97de6907-6131-4688-ab0d-34e81e99e379) · [Component](../apple-music-clone/components/music-auth.tsx)
...
- [x] **UI-42098642 — Home — scrolled to add library.** Coded UI; current browser render passed.
  ...
  - [Reference image](../apple-music-clone/reference/originals/42098642-4b2d-429d-8fd9-9afc2711c1ed.webp) · [Open app state](http://127.0.0.1:6435/screen/42098642-4b2d-429d-8fd9-9afc2711c1ed) · [Component](../apple-music-clone/components/music-discovery.tsx)
...
- [x] **UI-0c6da10e — Expanded song player — track menu / playlist flyout, lyrics visible.** Coded UI; current browser render passed.
  ...
  - [Reference image](../apple-music-clone/reference/originals/0c6da10e-2903-4869-aea9-34ae60cc5c20.webp) · [Open app state](http://127.0.0.1:6435/screen/0c6da10e-2903-4869-aea9-34ae60cc5c20) · [Component](../apple-music-clone/components/music-menus.tsx)
...
- [x] **UI-55ae9e4c — Expanded song player — create-playlist dialog, lyrics visible.** Coded UI; current browser render passed.
  ...
  - [Reference image](../apple-music-clone/reference/originals/55ae9e4c-a54e-4a75-a0cd-676023a17aea.webp) · [Open app state](http://127.0.0.1:6435/screen/55ae9e4c-a54e-4a75-a0cd-676023a17aea) · [Component](../apple-music-clone/components/music-create-playlist.tsx)
...
- [x] **UI-67446c83 — Expanded song player — create-playlist dialog, filled, lyrics visible.** Coded UI; current browser render passed.
  ...
  - [Reference image](../apple-music-clone/reference/originals/67446c83-fa8a-4824-905f-eefca9bf82b6.webp) · [Open app state](http://127.0.0.1:6435/screen/67446c83-fa8a-4824-905f-eefca9bf82b6) · [Component](../apple-music-clone/components/music-create-playlist.tsx)
...
- [x] **UI-3c1805b6 — Expanded song player — create-playlist dialog, filled, lyrics visible.** Coded UI; current browser render passed.
  ...
  - [Reference image](../apple-music-clone/reference/originals/3c1805b6-47bd-43d5-a5c3-8f6109e7ae97.webp) · [Open app state](http://127.0.0.1:6435/screen/3c1805b6-47bd-43d5-a5c3-8f6109e7ae97) · [Component](../apple-music-clone/components/music-create-playlist.tsx)
...
- [x] **UI-a4d30e7d — Expanded song player — lyrics visible.** Coded UI; current browser render passed.
  ...
  - [Reference image](../apple-music-clone/reference/originals/a4d30e7d-ea87-4cbe-a591-d51ab9ac879a.webp) · [Open app state](http://127.0.0.1:6435/screen/a4d30e7d-ea87-4cbe-a591-d51ab9ac879a) · [Component](../apple-music-clone/components/music-player.tsx)
...
- [x] **UI-06a34864 — Expanded song player — lyrics hidden.** Coded UI; current browser render passed.
  ...
  - [Reference image](../apple-music-clone/reference/originals/06a34864-602c-4163-b552-1bf12d426aba.webp) · [Open app state](http://127.0.0.1:6435/screen/06a34864-602c-4163-b552-1bf12d426aba) · [Component](../apple-music-clone/components/music-player.tsx)
...
- [x] **UI-de48a956 — New — queue panel / empty, playing stupid song.** Coded UI; current browser render passed.
  ...
  - `5929190`: Native 193px panel releases and corrected safe fragment coordinates; original over-20 residual 8.818291% → 8.439692%. Remaining visible differences are not signed off. [Evidence](reference-review/2026-09-13-main-discovery-artwork.md).
  - [Reference image](../apple-music-clone/reference/originals/de48a956-6060-4086-b8ed-26e80ec6ac3e.webp) · [Open app state](http://127.0.0.1:6435/screen/de48a956-6060-4086-b8ed-26e80ec6ac3e) · [Component](../apple-music-clone/components/music-player.tsx)
...
- [x] **UI-4811dde3 — New — queue panel, playing stupid song, autoplay on.** Coded UI; current browser render passed.
  ...
  - `5929190`: Native 193px panel releases and corrected safe fragment coordinates; original over-20 residual 9.951704% → 9.623862%. Remaining visible differences are not signed off. [Evidence](reference-review/2026-09-13-main-discovery-artwork.md).
  - [Reference image](../apple-music-clone/reference/originals/4811dde3-bebc-4792-a524-f0137e2e4753.webp) · [Open app state](http://127.0.0.1:6435/screen/4811dde3-bebc-4792-a524-f0137e2e4753) · [Component](../apple-music-clone/components/music-player.tsx)
...
- [x] **UI-e4dad439 — New — playing stupid song, volume 50%.** Coded UI; current browser render passed.
  ...
  - 2026-09-16: Applied the legacy catalog's measured player glass and preserved source-specific lower-release artwork through real controls; whole-frame MAE 5.835683 → 5.700218 and over-20 6.179556% → 5.701058%. Exact captions, typography, symbols and remaining state-specific content keep MATCH open. [Evidence](reference-review/2026-09-16-release-editions-legacy-player.md).
  - `5929190`: Discovery artwork/geometry and live player-state refinement; original over-20 residual 8.387474% → 6.401886%. Remaining visible differences are not signed off. [Evidence](reference-review/2026-09-13-main-discovery-artwork.md).
  - [Reference image](../apple-music-clone/reference/originals/e4dad439-32c1-4a28-954c-1d945b9e37e8.webp) · [Open app state](http://127.0.0.1:6435/screen/e4dad439-32c1-4a28-954c-1d945b9e37e8) · [Component](../apple-music-clone/components/music-player.tsx)
...
- [x] **UI-cbbdc344 — New — playing stupid song, volume 5%.** Coded UI; current browser render passed.
  ...
  - 2026-09-16: Applied the legacy catalog's measured player glass and preserved source-specific lower-release artwork through real controls; whole-frame MAE 5.870749 → 5.734741 and over-20 6.177249% → 5.691214%. Exact captions, typography, symbols and remaining state-specific content keep MATCH open. [Evidence](reference-review/2026-09-16-release-editions-legacy-player.md).
  - `5929190`: Discovery artwork/geometry and live player-state refinement; original over-20 residual 8.385167% → 6.400655%. Remaining visible differences are not signed off. [Evidence](reference-review/2026-09-13-main-discovery-artwork.md).
  - [Reference image](../apple-music-clone/reference/originals/cbbdc344-c1ba-4774-b90b-c70e276dec6d.webp) · [Open app state](http://127.0.0.1:6435/screen/cbbdc344-c1ba-4774-b90b-c70e276dec6d) · [Component](../apple-music-clone/components/music-player.tsx)
...
- [x] **UI-95ae6a8f — New — playing stupid song, volume 100%.** Coded UI; current browser render passed.
  ...
  - 2026-09-16: Applied the legacy catalog's measured player glass and preserved source-specific lower-release artwork through real controls; whole-frame MAE 5.763810 → 5.659733 and over-20 6.182555% → 5.707595%. Exact captions, typography, symbols and remaining state-specific content keep MATCH open. [Evidence](reference-review/2026-09-16-release-editions-legacy-player.md).
  - `5929190`: Discovery artwork/geometry and live player-state refinement; original over-20 residual 8.394395% → 6.403885%. Remaining visible differences are not signed off. [Evidence](reference-review/2026-09-13-main-discovery-artwork.md).
  - [Reference image](../apple-music-clone/reference/originals/95ae6a8f-cc7b-4594-8ec6-05e1936ad1a1.webp) · [Open app state](http://127.0.0.1:6435/screen/95ae6a8f-cc7b-4594-8ec6-05e1936ad1a1) · [Component](../apple-music-clone/components/music-player.tsx)
...
- [x] **UI-6337700d — Song credits — playing stupid song.** Coded UI; current browser render passed.
  ...
  - [Reference image](../apple-music-clone/reference/originals/6337700d-b701-48e5-8701-01c933605073.webp) · [Open app state](http://127.0.0.1:6435/screen/6337700d-b701-48e5-8701-01c933605073) · [Component](../apple-music-clone/components/music-credits.tsx)
...
- [x] **UI-2278b1d0 — Song credits — playing stupid song, scrolled to production.** Coded UI; current browser render passed.
  ...
  - [Reference image](../apple-music-clone/reference/originals/2278b1d0-6539-48bf-b131-f94dd838a6fe.webp) · [Open app state](http://127.0.0.1:6435/screen/2278b1d0-6539-48bf-b131-f94dd838a6fe) · [Component](../apple-music-clone/components/music-credits.tsx)
...
- [x] **UI-a0809fad — Concert discovery — named profile.** Coded UI; current browser render passed.
  ...
  - [Reference image](../apple-music-clone/reference/originals/a0809fad-42f4-4829-a68f-fc496d89a6e5.webp) · [Open app state](http://127.0.0.1:6435/screen/a0809fad-42f4-4829-a68f-fc496d89a6e5) · [Component](../apple-music-clone/components/music-concerts.tsx)
...
- [x] **UI-70566e85 — Concert discovery — scrolled to nashville.** Coded UI; current browser render passed.
  ...
  - [Reference image](../apple-music-clone/reference/originals/70566e85-0ab4-4f53-9ca6-7c3e5cb12d3f.webp) · [Open app state](http://127.0.0.1:6435/screen/70566e85-0ab4-4f53-9ca6-7c3e5cb12d3f) · [Component](../apple-music-clone/components/music-concerts.tsx)
...
- [x] **UI-4f237528 — Concert detail — scrolled state.** Coded UI; current browser render passed.
  ...
  - [Reference image](../apple-music-clone/reference/originals/4f237528-396a-471b-be14-5ff7ffd1aa3f.webp) · [Open app state](http://127.0.0.1:6435/screen/4f237528-396a-471b-be14-5ff7ffd1aa3f) · [Component](../apple-music-clone/components/music-concerts.tsx)
...
- [x] **UI-bd89b0a1 — Concert discovery — location menu.** Coded UI; current browser render passed.
  ...
  - [Reference image](../apple-music-clone/reference/originals/bd89b0a1-f1ab-499d-8feb-9d0bcbae9f57.webp) · [Open app state](http://127.0.0.1:6435/screen/bd89b0a1-f1ab-499d-8feb-9d0bcbae9f57) · [Component](../apple-music-clone/components/music-concerts.tsx)
...
- [x] **UI-1cd4d25b — Concert discovery — location menu, Singapore.** Coded UI; current browser render passed.
  ...
  - [Reference image](../apple-music-clone/reference/originals/1cd4d25b-8b27-40f0-ab65-bf82892a4a98.webp) · [Open app state](http://127.0.0.1:6435/screen/1cd4d25b-8b27-40f0-ab65-bf82892a4a98) · [Component](../apple-music-clone/components/music-concerts.tsx)
...
- [x] **UI-f78d223e — Concert discovery — location menu, chicago.** Coded UI; current browser render passed.
  ...
  - [Reference image](../apple-music-clone/reference/originals/f78d223e-9ba1-4898-b5bd-93390d4da1cc.webp) · [Open app state](http://127.0.0.1:6435/screen/f78d223e-9ba1-4898-b5bd-93390d4da1cc) · [Component](../apple-music-clone/components/music-concerts.tsx)
...
- [x] **UI-84b9db6f — Concert discovery — Chicago, IL.** Coded UI; current browser render passed.
  ...
  - [Reference image](../apple-music-clone/reference/originals/84b9db6f-94ea-4a0e-8e3b-e0a8c63cc0ba.webp) · [Open app state](http://127.0.0.1:6435/screen/84b9db6f-94ea-4a0e-8e3b-e0a8c63cc0ba) · [Component](../apple-music-clone/components/music-concerts.tsx)
...
- [x] **UI-e1069ba9 — Concert discovery — date-range dialog, step 1, Chicago, IL.** Coded UI; current browser render passed.
  ...
  - [Reference image](../apple-music-clone/reference/originals/e1069ba9-2687-468c-bdb9-b81733b7be0f.webp) · [Open app state](http://127.0.0.1:6435/screen/e1069ba9-2687-468c-bdb9-b81733b7be0f) · [Component](../apple-music-clone/components/music-concert-dates.tsx)
...
- [x] **UI-b896bf23 — Concert discovery — date-range dialog, step 2, Chicago, IL.** Coded UI; current browser render passed.
  ...
  - [Reference image](../apple-music-clone/reference/originals/b896bf23-466c-42f0-9298-dbbb6756bd10.webp) · [Open app state](http://127.0.0.1:6435/screen/b896bf23-466c-42f0-9298-dbbb6756bd10) · [Component](../apple-music-clone/components/music-concert-dates.tsx)
...
- [x] **UI-e1f20d4a — Concert discovery — date-range dialog, step 2, filled, Chicago, IL.** Coded UI; current browser render passed.
  ...
  - [Reference image](../apple-music-clone/reference/originals/e1f20d4a-7783-48e3-913e-23727f90aa1f.webp) · [Open app state](http://127.0.0.1:6435/screen/e1f20d4a-7783-48e3-913e-23727f90aa1f) · [Component](../apple-music-clone/components/music-concert-dates.tsx)
...
- [x] **UI-83bba8fd — Concert discovery — Chicago, IL, Jul 1 - Jul 12.** Coded UI; current browser render passed.
  ...
  - [Reference image](../apple-music-clone/reference/originals/83bba8fd-64eb-427b-82eb-1c1c9b954748.webp) · [Open app state](http://127.0.0.1:6435/screen/83bba8fd-64eb-427b-82eb-1c1c9b954748) · [Component](../apple-music-clone/components/music-concerts.tsx)
...
- [x] **UI-99ffee15 — Concert discovery — genres menu, Chicago, IL, Jul 1 - Jul 12.** Coded UI; current browser render passed.
  ...
  - [Reference image](../apple-music-clone/reference/originals/99ffee15-7ca3-4cfe-9a32-274237dffb0b.webp) · [Open app state](http://127.0.0.1:6435/screen/99ffee15-7ca3-4cfe-9a32-274237dffb0b) · [Component](../apple-music-clone/components/music-concerts.tsx)
...
- [x] **UI-d6b9a1a7 — Concert discovery — Chicago, IL, Jul 1 - Jul 12, R&B/Soul.** Coded UI; current browser render passed.
  ...
  - [Reference image](../apple-music-clone/reference/originals/d6b9a1a7-e7fe-44d4-bdc1-8fb7ee990c8f.webp) · [Open app state](http://127.0.0.1:6435/screen/d6b9a1a7-e7fe-44d4-bdc1-8fb7ee990c8f) · [Component](../apple-music-clone/components/music-concerts.tsx)
...
- [x] **UI-e757eb0f — Recently Added — named profile.** Coded UI; current browser render passed.
  ...
  - [Reference image](../apple-music-clone/reference/originals/e757eb0f-2d7c-48e6-a37f-54ce600c0a8f.webp) · [Open app state](http://127.0.0.1:6435/screen/e757eb0f-2d7c-48e6-a37f-54ce600c0a8f) · [Component](../apple-music-clone/components/music-library.tsx)
...
- [x] **UI-ffc18eb8 — New — edit navigation, superbloom featured cards.** Coded UI; current browser render passed.
  ...
  - 2026-09-12: Included in the final full comparison and continuous library-control review; MATCH remains open. [Exact candidate, evidence and counter-evidence](reference-review/2026-09-12-library-controls.md).
  - [Reference image](../apple-music-clone/reference/originals/ffc18eb8-5cbb-4e01-b066-867308585f5f.webp) · [Open app state](http://127.0.0.1:6435/screen/ffc18eb8-5cbb-4e01-b066-867308585f5f) · [Component](../apple-music-clone/components/music-discovery.tsx)
...
- [x] **UI-3728aa07 — New — edit navigation, superbloom featured cards.** Coded UI; current browser render passed.
  ...
  - 2026-09-12: Included in the final full comparison and continuous library-control review; MATCH remains open. [Exact candidate, evidence and counter-evidence](reference-review/2026-09-12-library-controls.md).
  - [Reference image](../apple-music-clone/reference/originals/3728aa07-f749-4edd-8c9f-f2f606649f04.webp) · [Open app state](http://127.0.0.1:6435/screen/3728aa07-f749-4edd-8c9f-f2f606649f04) · [Component](../apple-music-clone/components/music-discovery.tsx)
...
- [x] **UI-e5e8383f — New — superbloom featured cards.** Coded UI; current browser render passed.
  ...
  - 2026-09-12: Included in the final full comparison and continuous library-control review; MATCH remains open. [Exact candidate, evidence and counter-evidence](reference-review/2026-09-12-library-controls.md).
  - [Reference image](../apple-music-clone/reference/originals/e5e8383f-21d7-4eea-873e-25874adfa906.webp) · [Open app state](http://127.0.0.1:6435/screen/e5e8383f-21d7-4eea-873e-25874adfa906) · [Component](../apple-music-clone/components/music-discovery.tsx)

<a id="screen-fc5d84bd"></a>

- [x] **UI-fc5d84bd — New — profile menu.** Coded UI; current browser render passed.
  - [x] **MATCH-fc5d84bd — Finish and verify the exact screenshot match.**
  - 2026-09-25: Exact production source/render/residual review accepts the one-row profile-menu frame; menu geometry, account chrome, editorial edition and player state align without a concrete product mismatch. [Evidence](reference-review/2026-09-23-account-settings-flow-review.md#profile-menu-and-logout-acceptance--2026-09-25).
  - 2026-09-16: Corrected the shared current lower-release edition and all five lawful visible source fragments; whole-frame MAE 6.502876 → 5.659727 and over-20 7.189574% → 6.048734%. Exact captions, typography, symbols and remaining state-specific content keep MATCH open. [Evidence](reference-review/2026-09-16-release-editions-legacy-player.md).
  - `5929190`: Discovery artwork/geometry and live player-state refinement; original over-20 residual 7.151011% → 7.111372%. Remaining visible differences are not signed off. [Evidence](reference-review/2026-09-13-main-discovery-artwork.md).
  - [Reference image](../apple-music-clone/reference/originals/fc5d84bd-aeee-420d-aef0-7c1681d8f1c2.webp) · [Open app state](http://127.0.0.1:6435/screen/fc5d84bd-aeee-420d-aef0-7c1681d8f1c2) · [Component](../apple-music-clone/components/music-menus.tsx)
...
- [ ] **FLOW-bc4b3fa8 — 3. New (5 steps).** Complete and verify the recorded journey.
  - 2026-09-15: The five New checkpoints still traverse through real hover, carousel and wheel controls. Reviewed Viral Hits material and the live New Music Daily continuation reduce continuous Alpha 9.915329% → 8.741156% while preserving the 0.977375% direct/live session gap. The full flow remains unsigned. [Evidence](reference-review/2026-09-15-alpha-material-continuation.md).
  - `5929190`: The five New checkpoints still traverse through real controls. New shelves/badges and material persistence are corrected; live Alpha remains 10.639766% from its original and 1.880460% from its fixture. No scenario data was silently replaced. [Evidence](reference-review/2026-09-13-main-discovery-artwork.md).
...
- [ ] **FLOW-6652f3e8 — 11. Adding to a playlist (6 steps).** Complete and verify the recorded journey.
  - [Open first recorded state](http://127.0.0.1:6435/flows/adding-to-a-playlist?step=0). Sequence: [1: ac05c6b8](#screen-ac05c6b8) → [2: 0c6da10e](#screen-0c6da10e) → [3: 55ae9e4c](#screen-55ae9e4c) → [4: 67446c83](#screen-67446c83) → [5: 3c1805b6](#screen-3c1805b6) → [6: a4d30e7d](#screen-a4d30e7d)

- [ ] **FLOW-ef26cd71 — 12. Song credits (3 steps).** Complete and verify the recorded journey.
  - [Open first recorded state](http://127.0.0.1:6435/flows/song-credits?step=0). Sequence: [1: ac05c6b8](#screen-ac05c6b8) → [2: 6337700d](#screen-6337700d) → [3: 2278b1d0](#screen-2278b1d0)
...
- [ ] **FLOW-7f504621 — 16. Clearing song queue (2 steps).** Complete and verify the recorded journey.
  ...
  - [Open first recorded state](http://127.0.0.1:6435/flows/clearing-song-queue?step=0). Sequence: [1: 8f029018](#screen-8f029018) → [2: de48a956](#screen-de48a956)
...
- [ ] **FLOW-fc3dbfae — 17. Enabling autoplay (2 steps).** Complete and verify the recorded journey.
  ...
  - [Open first recorded state](http://127.0.0.1:6435/flows/enabling-autoplay?step=0). Sequence: [1: 8f029018](#screen-8f029018) → [2: 4811dde3](#screen-4811dde3)

- [ ] **FLOW-47b2a149 — 18. Adjusting volume (4 steps).** Complete and verify the recorded journey.
  - [Open first recorded state](http://127.0.0.1:6435/flows/adjusting-volume?step=0). Sequence: [1: 1f9e170c](#screen-1f9e170c) → [2: e4dad439](#screen-e4dad439) → [3: cbbdc344](#screen-cbbdc344) → [4: 95ae6a8f](#screen-95ae6a8f)
...
- [ ] **FLOW-95cd6e33 — 29. Concerts (3 steps).** Complete and verify the recorded journey.
  - [Open first recorded state](http://127.0.0.1:6435/flows/concerts?step=0). Sequence: [1: 035569a0](#screen-035569a0) → [2: a0809fad](#screen-a0809fad) → [3: 70566e85](#screen-70566e85)

- [ ] **FLOW-1406ebf4 — 30. Concert detail (3 steps).** Complete and verify the recorded journey.
  - [Open first recorded state](http://127.0.0.1:6435/flows/concert-detail?step=0). Sequence: [1: 70566e85](#screen-70566e85) → [2: dcafd99e](#screen-dcafd99e) → [3: 4f237528](#screen-4f237528)

- [ ] **FLOW-97c2ae4a — 31. Setting a location (5 steps).** Complete and verify the recorded journey.
  - [Open first recorded state](http://127.0.0.1:6435/flows/setting-a-location?step=0). Sequence: [1: a0809fad](#screen-a0809fad) → [2: bd89b0a1](#screen-bd89b0a1) → [3: 1cd4d25b](#screen-1cd4d25b) → [4: f78d223e](#screen-f78d223e) → [5: 84b9db6f](#screen-84b9db6f)
...
- [x] **FLOW-079e1da7 — 52. Logging out (3 steps).** Complete and verify the recorded journey.
  - 2026-09-25: Accepted through the visible Account menu and Sign Out controls. All three source-ordered checkpoints were reviewed; the final signed-out live frame matches the source and direct candidate in copy, geometry, artwork and chrome, with only lawful repeat-run raster/decode variation, and the complete exact candidate passed with zero errors. [Evidence](reference-review/2026-09-23-account-settings-flow-review.md#profile-menu-and-logout-acceptance--2026-09-25).
  ...
  - 2026-09-23 historical diagnosis, superseded 2026-09-25: exact reinspection established that saved step 2 has All Playlists only; the accepted live path above now reproduces that state without replacing library data. [Updated evidence](reference-review/2026-09-23-account-settings-flow-review.md#profile-menu-and-logout-acceptance--2026-09-25).
...
- [ ] **FLOW-f5a37141 — 58. Logging in (7 steps).** Complete and verify the recorded journey.
  - [Open first recorded state](http://127.0.0.1:6435/flows/logging-in?step=0). Sequence: [1: 3731221f](#screen-3731221f) → [2: 3131018d](#screen-3131018d) → [3: 417f6129](#screen-417f6129) → [4: 6aa4a9d7](#screen-6aa4a9d7) → [5: 4e65c7c6](#screen-4e65c7c6) → [6: 97de6907](#screen-97de6907) → [7: e027fe6d](#screen-e027fe6d)
