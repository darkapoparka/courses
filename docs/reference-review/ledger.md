...
## Expanded UI families — 2026-09-09

The owner requested continuation beyond Home. The actual `flow-screen-map.json` was enumerated: 58 flows, 218 ordered steps, 159 unique screen identities. [The expanded flow coverage](flow-coverage.md) records every flow's course route, interaction or explicit boundary; its JSON companion retains every ordered source ID. This mapping is not a claim that 159 separate templates, original assets or all source interactions were reproduced pixel for pixel.

Thirty-three exact high-resolution originals were opened through the connected computer's image reader during this expansion. The full path list and the one failed, uncounted path are in the coverage record. No new acquisition, recording-playback or all-catalog visual-review claim is made. All source files and the archived prototype remain unchanged.

| Source family and exact anchor | Observed layout / interaction state | Implemented course adaptation |
| --- | --- | --- |
| Detail: `b620e4ab-d6dc-47c9-b704-6cd45cbd714c.webp`; description: `32515da3-7507-463f-baad-a257cfed078b.webp` | Square art beside compact identity/actions; ordered rows immediately below; centered prose dialog | Course cover/creator/outcomes/effort, preview/offer boundary, module rows, visitor/learner/complete/unavailable variants and More dialog |
| Search: `035569a0-e8da-454e-8bfd-83e7eacfecc5.webp`, `e70094e3-980e-4ba7-a454-e8dd6ce55ae4.webp` | Prominent search input, recent items, category art and distinct result groups | Real query/filter/sort URLs, course/creator results, recent-query removal, subject selection and empty/reset |
| Creator: `484851bf-bc23-4088-8a34-4078c4d6b4ff.webp` | Large image-led identity, featured item and preview rows followed by covers | Illustrative subject imagery, fictional creator identity, actual course/sample-preview destinations; no fabricated credentials or follower counts |
| Library: `e757eb0f-2d7c-48e6-a37f-54ce600c0a8f.webp`, `bdc69b59-1062-43ee-91da-589de56512b6.webp`, `92589389-e185-401c-a395-c646b801a0c4.webp` | Grid/empty/table families, captions outside art, compact metadata | Owned fixtures separate from tab-only Saved, grid/list/search/sort, lesson table/pins and recovery |
| Lists/menu: `8a2a4241-7833-471f-b5e4-72f89d71412b.webp`, `a573d1ab-e4c7-4f59-beb8-f2e171ba1530.webp`, `ac05c6b8-9970-422b-bbc1-3aaff880946c.webp` | Collection mosaics, identity/list rows, grouped concise menus | Learning-list create/edit/add/remove/reorder/delete; accessible course-action menus and actual local link copying |
| Media: `c939c9b8-e195-4e43-92a6-b845d0b99243.webp`, `a4afd6e6-eddb-4263-b7eb-5be73f8f2b03.webp` | Focused split media/text and unobstructed video surface | Native original sample video, readable transcript seeking, curriculum, captions/speed/repeat/fullscreen, notes/resources; no blurred study text or persistent music bar |
| Settings/auth: `481cd568-59d9-47ab-88fc-ec20f843d9c1.webp`, `3131018d-35b8-4527-a6fe-384fbe950fe7.webp` | Restrained account sections and focused email entry | Profile/prefs in this tab, sign-in/code/error/expiry UI without email/identity, empty purchases and explicit provider boundary |
| Additional families | Event/location/detail, channel/schedule, monthly recap/milestone, code-entry preferences and language setting | Isolated `/preview/` visual studies with conspicuous fictional data, no bookings/live broadcasts/achievements/security claims; English/Chinese selection applies only to its study |

All anchor names above are under `apple-music-clone/reference/originals/high-resolution/`. The lower Mobbin attribution strip is not app UI and is excluded from the comparison frames. No source artwork, font files or screenshots are used as the running application. Original/licensed photographs remain under `web/public/covers/`; the locally authored video, captions, poster and worksheet are under `web/public/sample/`.

The current comparison gallery is `docs/evidence/ui-platform-expansion/review.html`; it references original archive paths and actual course screenshots without copying reference bytes. Its family selector, desktop side-by-side/overlay and mobile modes were exercised locally. Desktop/mobile screenshots for the actual routes are in the same evidence directory. Final command results and limitations belong to `docs/tasks.md`.
