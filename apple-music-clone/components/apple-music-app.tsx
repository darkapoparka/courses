...
function MusicShell() {
  ...
  return <div className={`music-app ${m.scene.guest ? "guest-session" : "member-session"} ${m.scene.panel ? "with-player-panel" : ""} ${m.scene.checkout ? "checkout-stage" : ""}`} data-scene={m.scene.page} data-source={m.scene.source} data-flow={m.scene.flow} data-form-step={m.scene.formStep ?? 0}>
    ...
    <aside id="music-sidebar" className={`music-sidebar ${mobileNav ? "mobile-open" : ""}`} aria-label="Main navigation" style={m.scene.source?.startsWith("d5173715") ? { background: "rgb(255 246 235 / 50%)", backgroundImage: "radial-gradient(ellipse 38% 38% at 92% 40%,rgba(255,125,70,.09) 0%,transparent 84%),radial-gradient(ellipse 75% 24% at 72% 31%,rgba(255,220,70,.50) 0%,transparent 84%),radial-gradient(ellipse 55% 28% at 0% 34%,rgba(255,85,145,.30) 0%,transparent 84%),radial-gradient(ellipse 100% 18% at 42% 49%,rgba(255,205,75,.22) 0%,transparent 86%),radial-gradient(ellipse 105% 22% at 50% 40%,rgba(255,145,55,.16) 0%,transparent 86%),radial-gradient(ellipse 110% 18% at 45% 18%,rgba(255,205,90,.16) 0%,transparent 86%)", backdropFilter: "blur(16px) saturate(1)", WebkitBackdropFilter: "blur(16px) saturate(1)" } : m.scene.source?.startsWith("54b01eab") ? { backdropFilter: "blur(18px) saturate(1.15)", WebkitBackdropFilter: "blur(18px) saturate(1.15)" } : undefined}>
