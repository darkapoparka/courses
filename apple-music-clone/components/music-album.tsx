...
export function AlbumView() {
  ...
  return <div className={styles.page}>
    <div className={styles.tools}><IconButton icon="share" label={`Share ${albumTitle}`} onClick={event => m.openMenu("share", event, "album-2")} /><IconButton icon="more" label={`More actions for ${albumTitle}`} onClick={event => m.openMenu("album", event, "album-2")} /></div>
