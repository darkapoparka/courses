...
function Notice() { return <small className="reference-disclosure sr-only">Local preview only · Use example.test, code 123456 and password reference-preview. No information is sent to Apple.</small>; }
...
export function AuthenticationDialog() {
  ...
  const submit = (event: FormEvent) => {
    ...
    if (signup) {
      ...
      const onboarding = source === "ee751367" || source === "bdc56e10" || window.location.pathname.includes("/flows/onboarding");
