...
const definitions: Record<string, Scene> = {
  ...
  "b620e4ab": { page: "album", namedProfile: true, favourite: false },
  "ffd1356a": { page: "album", namedProfile: true, favourite: false, scroll: "other-versions" },
  "eb489e8d": { page: "album", namedProfile: true, favourite: false, scroll: "music-videos" },
  "32515da3": { page: "album", namedProfile: true, favourite: false, overlay: "article" },
  "9b43cccb": { page: "album", namedProfile: true, favourite: false, overlay: "article", scrollOffset: 300 },
  "56c2e39a": { page: "album", namedProfile: true, menu: "share", favourite: false },
  "ef86b595": { page: "album", namedProfile: true, menu: "album", favourite: false },
  "eca1baa1": { page: "album", namedProfile: true, menu: "album", filled: true, favourite: false },
  ...
  "898ca766": { page: "artist", namedProfile: true, personalPlaylistsEmpty: true, scroll: "music-videos" },
  ...
  "4cb8f3aa": { page: "radio", namedProfile: true, volume: 0.63 },
  "0920d819": { page: "radio", namedProfile: true, scroll: "radio-stations", volume: 0.63 },
  "a9992e55": { page: "radio", namedProfile: true, selectedTrack: "station-1", volume: 0.63 },
  "47a07865": { page: "radio", namedProfile: true, track: "station-1", snapshotPlaying: true, volume: 0.63 },
  "7bd2ef54": { page: "radio", namedProfile: true, track: "station-1", snapshotPlaying: true, expanded: true, volume: 0.63 },
  "37575452": { page: "radio", namedProfile: true, selectedTrack: "station-1", menu: "station", volume: 0.63 },
  "f49fce21": { page: "schedule", namedProfile: true },
  "bdc69b59": { page: "library", namedProfile: true, empty: true },
  ...
  "e9bee76d": { page: "songs", namedProfile: true, selectedTrack: "album-2" },
  "3884ff64": { page: "songs", namedProfile: true, selectedTrack: "album-2", menu: "track" },
  "06be9f09": { page: "songs", namedProfile: true, pinned: true },
  "4e857921": { page: "videos", namedProfile: true },
  "0b0e3fbf": { page: "made-for-you", namedProfile: true, empty: true },
  ...
  "3728aa07": { ...playing, track: undefined, snapshotPlaying: false, editingNav: true, hiddenNav: ["library", "albums", "made-for-you"] },
  "e5e8383f": { ...playing, track: undefined, snapshotPlaying: false, hiddenNav: ["library", "albums", "made-for-you"] },
  "fc5d84bd": { ...base, namedProfile: true, menu: "profile" },
  "481cd568": account,
  "1e5b4763": { ...account, scroll: "account-access" },
  "01f96377": { ...account, scroll: "parental-controls", personalPlaylistsEmpty: true },
